...
class Optimization:
    ...
    def train(self, train_features: torch.Tensor,targets:torch.Tensor, n_epochs:int = 50, model_path:str = "models/lstm_model.pt", forward_hn_cn:bool = False, plot_losses:bool = False):
        """
